...
//jaykrell-osf1 TODO port binutils
/* We are not using GAS.  */
#define TARGET_GAS 0

//jaykrell-osf1 copied from gcc-4.7.4/gcc/config/alpha/alpha.h
...
//jaykrell-osf1 ASM_OUTPUT_ALIGN is copied from gcc-4.7.4/alpha.h.
// It appears to move around as targets are added/removed/refactored.
// It is for dwarf2out.c, but OSF/1 uses stabs so it can probably
// be skipped, and disable the Dwarf code.
